...
metadata <- fslscopr::link_ethoscope_metadata(metadata, result_dir = system.file("extdata/ethoscope_data/results", package = "fslretho"))
raw_data <- fslscopr::load_ethoscope(metadata = metadata, reference_hour = NA)
